...
public class Television extends Electrodomestico {
	...
	public Television(String marca, String modelo, double precio, double peso, Eficiencia eficienciaE, Color color) {
		super(marca, modelo, precio, peso, eficienciaE, color);
		this.pulgadas = 50;
		this.tecnologia = TecnologiaLCD.QLED;
		this.resolucion = Resolucion.FHD;
	}
	
	public Television(String marca, String modelo, double precio, double peso,
			Eficiencia eficienciaE, Color color, int pulgadas, TecnologiaLCD tecno, Resolucion reso) {
		super(marca, modelo, precio, peso, eficienciaE, color);
